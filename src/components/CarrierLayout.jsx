  ...
  return (
    <div style={{ padding:16, paddingBottom:60, overflowY:'auto', height:'100%', boxSizing:'border-box', display:'flex', flexDirection:'column', gap:12 }}>
      ...
      {(() => {
        ...
        // Deduplicate: use totalRevenue if no date-filtered data
        const currentRev = periodRevenue || totalRevenue
        ...
        // Estimate loads needed (avg gross per delivered load)
        ...
        const saveGoal = () => {
          ...
          showToast && showToast(`${goalType === 'weekly' ? 'Weekly' : 'Monthly'} goal set to $${val.toLocaleString()}`)
        }

        return (
          <div style={{ ...pan, overflow:'hidden', position:'relative' }}>
            {/* Glow effect when goal hit */}
