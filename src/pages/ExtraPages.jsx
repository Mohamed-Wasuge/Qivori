      ...
      {step === 1 && (
        <div style={{ textAlign: 'center' }}>
          <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 36, letterSpacing: 3, marginBottom: 8 }}>
            Welcome to QI<span style={{ color: 'var(--accent)' }}>VORI</span> <span style={{ color: 'var(--accent2)', fontSize: 18 }}>AI</span>
          </div>
      ...
      <div style={{ maxWidth: 700 }}>
        ...
        <div className="panel fade-in" style={{ marginBottom: 16 }}>
          ...
          <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[
              { name: 'Basic (Carrier)', price: '$49/mo', users: '28 users', color: 'var(--accent2)' },
              { name: 'Pro (Carrier)', price: '$149/mo', users: '18 users', color: 'var(--accent)' },
              { name: 'Autopilot (Carrier)', price: '$299/mo', users: '12 users', color: 'var(--accent3)' },
              { name: 'Autopilot AI (Carrier)', price: '$799/mo', users: '6 users', color: '#f0a500' },
